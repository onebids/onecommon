...
import (
	"fmt"
	errno "github.com/onebids/onecommon/enums"
)
...
var (
	...
	RPCSystemSrvErr    = NewErrNo(int64(errno.Err_RPCSystemSrvErr), "rpc system service error")
	SystemSrvErr       = NewErrNo(int64(errno.Err_SystemSrvErr), "system service error")
